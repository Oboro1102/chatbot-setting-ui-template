...
`,classes:{root:function(e){var t=e.props;return[`p-floatlabel`,{"p-floatlabel-over":t.variant===`over`,"p-floatlabel-on":t.variant===`on`,"p-floatlabel-in":t.variant===`in`}]}}}),X={name:`FloatLabel`,extends:{name:`BaseFloatLabel`,extends:d,props:{variant:{type:String,default:`over`}},style:Y,provide:function(){return{$pcFloatLabel:this,$parentInstance:this}}},inheritAttrs:!1};function Z(e,t,n,r,i,a){return u(),s(`span`,_({class:e.cx(`root`)},e.ptmi(`root`)),[g(e.$slots,`default`)],16)}X.render=Z;export{b as a,x as i,I as n,D as r,X as t};